                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-12"> 
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check">
                                                                <input id="exibivaloresim" class="form-check-input" type="radio" value="1" name="exibir_valores" {{(old('exibir_valores') == '1' ? 'checked' : ($apartamento->exibir_valores == '1' ? 'checked' : ''))}}>
                                                                <label for="exibivaloressim" class="form-check-label mr-5">Sim</label>
                                                                <input id="exibivaloresnao" class="form-check-input" type="radio" value="0" name="exibir_valores" {{(old('exibir_valores') == '0' ? 'checked' : ($apartamento->exibir_valores == '0' ? 'checked' : ''))}}>
                                                    ...
                                                    <div class="col-12 col-md-3 col-lg-3"> 
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control mask-money" name="valor_cafe" value="{{old('valor_cafe') ?? $apartamento->valor_cafe}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-3 col-lg-3"> 
                                                        <div class="form-group">
                                                            <label class="labelforms"><b>Valor c/ Café da Manhã & Almoço</b></label>
                                                            <input type="text" class="form-control mask-money" name="valor_cafe_almoco" value="{{old('valor_cafe_almoco') ?? $apartamento->valor_cafe_almoco}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-3 col-lg-3"> 
                                                        <div class="form-group">
                                                            <label class="labelforms"><b>Valor com Café & Janta</b></label>
                                                            <input type="text" class="form-control mask-money" name="valor_cafe_janta" value="{{old('valor_cafe_janta') ?? $apartamento->valor_cafe_janta}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-3 col-lg-3"> 
                                                        <div class="form-group">
                                                            <label class="labelforms"><b>Valor 0 a 5 anos</b></label>
                                                            <input type="text" class="form-control mask-money" name="valor_cri_0_5" value="{{old('valor_cri_0_5') ?? $apartamento->valor_cri_0_5}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body">                                                
                                                <div class="row mb-2">
                                                    <div class="col-12">   
                                                        ...
                                                        <x-adminlte-text-editor name="descricao" v placeholder="Descrição do Apartamento..." :config="$config">{{ old('descricao') ?? $apartamento->descricao }}</x-adminlte-text-editor>                                                      
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                                    <div class="col-12">   
                                                        <label class="labelforms"><b>Notas Adicionais</b></label>
                                                        <textarea id="inputDescription" class="form-control" rows="5" name="notasadicionais">{{ old('notasadicionais') ?? $apartamento->notasadicionais}}</textarea>                                                      
                                                    </div>
                                                </div>                                                
                                            </div>
                                        </div>
                                ...
                                <div class="row mb-4">                                     
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">                                        
                                        ...
                                        <div class="form-group p-3 mb-1">                                            
                                            ...
                                            <div class="form-check mb-2">
                                                <input id="ventilador_teto" class="form-check-input" type="checkbox"  name="ventilador_teto" {{ (old('ventilador_teto') == 'on' || old('ventilador_teto') == true ? 'checked' : ($apartamento->ventilador_teto == true ? 'checked' : '')) }}>
                                ...
                                <div class="row mb-4">
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6"> 
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input id="exibirmarcadaguasim" class="form-check-input" type="radio" value="1" name="exibirmarcadagua" {{(old('exibirmarcadagua') == '1' ? 'checked' : ($apartamento->exibirmarcadagua == '1' ? 'checked' : ''))}}>
                                                <label for="exibirmarcadaguasim" class="form-check-label mr-5">Sim</label>
                                                <input id="exibirmarcadaguanao" class="form-check-input" type="radio" value="0" name="exibirmarcadagua" {{(old('exibirmarcadagua') == '0' ? 'checked' : ($apartamento->exibirmarcadagua == '0' ? 'checked' : ''))}}>
                                    ...
                                    <div class="col-sm-12">                                        
                                        ...
                                        <div class="property_image">
                                            @foreach($apartamento->images()->get() as $image)
                                                <div class="property_image_item">
                                                    ...
                                                    <div class="property_image_actions">
                                                        <a href="javascript:void(0)" class="btn btn-xs {{ ($image->cover == true ? 'btn-success' : 'btn-default') }} icon-notext image-set-cover" data-action="{{ route('apartamentos.imageSetCover', ['image' => $image->id]) }}"><i class="nav-icon fas fa-check"></i> </a>
                                                        <a href="javascript:void(0)" class="btn btn-danger btn-xs icon-notext image-remove px-2" data-action="{{ route('apartamentos.imageRemove', ['image' => $image->id]) }}"><i class="nav-icon fas fa-times"></i> </a>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                ...
                                <div class="row mb-2 text-muted">                                   
                                    <div class="col-12 col-md-6 col-lg-6">   
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="headline" value="{{old('headline') ?? $apartamento->headline}}">
                                        </div>                                                    
                                    </div>                                                                       
                                    <div class="col-12 mb-1"> 
                                        <div class="form-group">
                                            <label class="labelforms"><b>MetaTags</b></label>
                                            <input id="tags_1" class="tags" rows="5" name="metatags" value="{{ old('metatags') ?? $apartamento->metatags }}">
                                        </div>
                                    </div>
                                    <div class="col-12"> 
                                        <div class="form-group">
                                            <label class="labelforms"><b>Youtube Vídeo</b></label>
                                            <textarea id="inputDescription" class="form-control" rows="5" name="youtube_video">{{ old('youtube_video') ?? $apartamento->youtube_video }}</textarea> 
                                        </div>
                                    </div>
                                </div> 
                            </div>
