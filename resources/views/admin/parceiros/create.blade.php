...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1><i class="fas fa-search mr-2"></i>Cadastrar Parceiro</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Painel de Controle</a></li>
            <li class="breadcrumb-item"><a href="{{route('parceiros.index')}}">Parceiros</a></li>
            <li class="breadcrumb-item active">Cadastrar Parceiro</li>
        </ol>
    </div>
</div> 
@stop
...
<form action="{{ route('parceiros.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
@csrf     
<div class="row">            
<div class="col-12">
