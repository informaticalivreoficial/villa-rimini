...
<form action="{{ route('listas.update', [ 'id' => $lista->id ]) }}" method="post" autocomplete="off">
@csrf    
@method('PUT')       
<div class="row">            
    <div class="col-12">
                       ...
                       <div class="row">
                            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="servidor_smtp" value="{{ old('servidor_smtp') ?? $lista->servidor_smtp }}">
                                </div> 
                            </div>
                            <div class="col-12 col-sm-6 col-md-4 col-lg-4">   
                                <div class="form-group">
                                    <label class="labelforms text-muted"><b>Usuário SMTP</b></label>
                                    <input type="text" class="form-control" name="servidor_email" value="{{ old('servidor_email') ?? $lista->servidor_email }}">
                                </div>                                                    
                            </div>
                            <div class="col-12 col-sm-6 col-md-2 col-lg-2">   
                                <div class="form-group">
                                    <label class="labelforms text-muted"><b>Porta SMTP</b></label>
                                    <input type="text" class="form-control" name="servidor_porta" value="{{ old('servidor_porta') ?? $lista->servidor_porta }}">
                                </div>                                                    
                            </div>
                            <div class="col-12 col-sm-6 col-md-2 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">                                        
                                        <input type="password" class="form-control" id="senha" name="servidor_senha" value="{{ old('servidor_senha') ?? $lista->servidor_senha }}">
